...
function createSectionElement(section, sectionName) {
  ...
  if (!isCard && section.contentSettings.content !== 'No text for card, use Middle instead!') {
  ...
  element.style.textDecoration = [textSettings.underline && 'underline', textSettings.strikethrough && 'line-through']
    .filter(Boolean)
    .join(' ');
...
export function generateHTML() {
  ...
  if (hasContent(state.sections.top.contentSettings.content)) {
    ...
    top.style.top = state.sections.top.contentSettings.leftPosition + '%';
    top.style.left = state.sections.top.contentSettings.topPosition + '%';
    top.style.right = state.sections.top.contentSettings.rightPosition + '%';
    top.style.bottom = state.sections.top.contentSettings.bottomPosition + '%';
  ...
  if (hasContent(state.sections.bottom.contentSettings.content)) {
    ...
    bottom.style.top = state.sections.bottom.contentSettings.leftPosition + '%';
    bottom.style.left = state.sections.bottom.contentSettings.topPosition + '%';
    bottom.style.right = state.sections.bottom.contentSettings.rightPosition + '%';
    bottom.style.bottom = state.sections.bottom.contentSettings.bottomPosition + '%';
  ...
  if (hasContent(state.sections.left.contentSettings.content)) {
    ...
    left.style.top = state.sections.left.contentSettings.leftPosition + '%';
    left.style.left = state.sections.left.contentSettings.topPosition + '%';
    left.style.right = state.sections.left.contentSettings.rightPosition + '%';
    left.style.bottom = state.sections.left.contentSettings.bottomPosition + '%';
  ...
  if (hasContent(state.sections.right.contentSettings.content)) {
    ...
    right.style.top = state.sections.right.contentSettings.leftPosition + '%';
    right.style.left = state.sections.right.contentSettings.topPosition + '%';
    right.style.right = state.sections.right.contentSettings.rightPosition + '%';
    right.style.bottom = state.sections.right.contentSettings.bottomPosition + '%';
  ...
  if (hasContent(state.sections.middle.contentSettings.content)) {
    ...
    middle.style.top = state.sections.middle.contentSettings.leftPosition + '%';
    middle.style.left = state.sections.middle.contentSettings.topPosition + '%';
    middle.style.right = state.sections.middle.contentSettings.rightPosition + '%';
    middle.style.bottom = state.sections.middle.contentSettings.bottomPosition + '%';
